...
import 'details13_property_hall_model.dart';
export 'details13_property_hall_model.dart';

class Details13PropertyHallWidget extends StatefulWidget {
  const Details13PropertyHallWidget({super.key});

  @override
  State<Details13PropertyHallWidget> createState() =>
      _Details13PropertyHallWidgetState();
}

class _Details13PropertyHallWidgetState
    extends State<Details13PropertyHallWidget> {
  late Details13PropertyHallModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Details13PropertyHallModel());
